...
{
  Task<string> GetResultsAsync(List<int> typeIds, DateOnly before, DateOnly after);
}
...
public class NedService : INedService
{
  ...
  public async Task<string> GetResultsAsync(List<int> typeIds, DateOnly before, DateOnly after)
  {
